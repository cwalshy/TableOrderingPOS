...
const routes: Routes = [
  ...
  { path: 'stripe-checkout/:stripe-checkout', component: SuccessComponent, pathMatch: 'full' },
  ...
  { path: 'table/:table/products/addToCart/:id',  pathMatch: 'full', component: ProductComponent },
  { path: 'login',  pathMatch: 'full', component: LoginComponent },
  { path: 'orders/shift-reports',  pathMatch: 'full', component: ShiftReportsComponent},
  { path: 'orders/update-menu',  pathMatch: 'full', component: UpdateMenuComponent},
