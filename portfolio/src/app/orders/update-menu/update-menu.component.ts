...
export class UpdateMenuComponent implements OnInit {
  ...
  constructor(changeDetectorRef: ChangeDetectorRef, media: MediaMatcher, public dialog: MatDialog, private db: AngularFirestore, private productService: ProductService, private ordersService: OrdersService) {
